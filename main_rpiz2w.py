#!/usr/bin/env python3
"""
Mindfulness BGM Generator - Raspberry Pi Zero 2 W Version
Optimized for lower-power devices with modular structure
"""
...
from src.config_rpiz2w import SAMPLE_RATE, BUFFER_FRAMES, DEFAULT_AMBIENT_RATIO
from src.instruments_base import InstrumentConfig
from src.generator_rpiz2w import MindfulnessBGMRPiZ2W
from src.utils import parse_instrument_interval, parse_ambient_value


def parse_arguments():
    """Parse command line arguments"""
    parser = argparse.ArgumentParser(description="Mindfulness BGM Generator - Raspberry Pi Zero 2 W Version")
...
def display_settings(instrument_configs, ambient_ratio):
    ...
    print("Starting mindfulness BGM (Raspberry Pi Zero 2 W Optimized Version)...")
    print("\nSettings:")
    print("- Four meditation instruments optimized for RPi Zero 2 W")
    print("- Simple reverb effect (0.1s)")
    print("- Optimized audio quality (16kHz)")
    print("- Basic stereo separation")
    print("- Smooth transitions (2s)")
    print("- Lower CPU usage optimizations")
...
def main():
    ...
    try:
        ...
        # Create generator
        generator = MindfulnessBGMRPiZ2W(
